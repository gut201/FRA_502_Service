...
Goal = {"room_1":[-2.5,2,-0.6601,0.7511],
        "room_2":[2.5,2,-0.6601,0.7511],
        "room_3":[6.5,2,-0.6601,0.7511],
        "room_4":[6.5,-4.5,-0.6601,0.7511],
        "room_5":[2.5,-4.5,-0.6601,0.7511],
        
        "Standby_Station":[-8,-5,-0.6601,0.7511]}
                ...
                try:
                    with sr.Microphone() as source:                
                        ...
                        try:
                            ...
                            rospy.loginfo("Command Example : ไปห้อง ")
                            pass
